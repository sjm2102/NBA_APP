...
function buildMoneylineTable(el, data){
  return new Tabulator(el, {
    ...
    // ✅ prevents “frozen” separator artifacts
    movableColumns: false,
    resizableColumnFit: true,

    initialSort: [{column:"home_win_prob", dir:"desc"}],
    columns: [
      {title:"Away", field:"away", minWidth: 110, widthGrow: 2, frozen:false},
      {title:"Home", field:"home", minWidth: 110, widthGrow: 2, frozen:false},
      {title:"Home Win %", field:"home_win_prob", formatter:c=>pct(c.getValue()), hozAlign:"right", width: 120, frozen:false},
      {title:"Away Win %", field:"away_win_prob", formatter:c=>pct(c.getValue()), hozAlign:"right", width: 120, frozen:false},
    ]
  });
}
...
function buildLinesTable(el, data){
  return new Tabulator(el, {
    ...
    columns: [
      {title:"Player", field:"Player", minWidth: 180, widthGrow: 4, frozen:false},
      {title:"Team", field:"Team", width: 80, frozen:false},
      {title:"Opp", field:"Opponent", width: 80, frozen:false},
      {title:"Line", field:"line", hozAlign:"right", width: 80, frozen:false},
      {title:"Model %", field:"best_prob", formatter:c=>pct(c.getValue()), hozAlign:"right", width: 95, frozen:false},
      {title:"Edge", field:"best_edge", formatter:c=>num(c.getValue(),3), hozAlign:"right", width: 90, frozen:false},
      {title:"EV/$1", field:"best_ev_$1", formatter:c=>num(c.getValue(),3), hozAlign:"right", minWidth: 90, widthGrow: 2, frozen:false},
    ]
  });
}
